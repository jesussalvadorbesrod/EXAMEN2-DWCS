...
create database examenud4 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
-- Seleccionamos la base de datos "examenud4"
use examenud4;
...
-- 4.- Le damos permiso en la base de datos "examenud4"
grant all on examenud4.* to gestor@'localhost';