drop database if exists examenud4ampliado;
create database examenud4ampliado DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
grant all on examenud4ampliado.* to gestor@'localhost';
